...
class Packing:
    ...
    def __init__(self, num_dim, num_particles):
        ...
        self.volume_constant = pm.sphere_volume_constant(self.num_dim)
        self.stiffness = 1.0
    ...
    def get_volume(self):
        return pm.determinant(self.basis, self.num_dim)
    ...
    def calc_basis_forces(self, pressure):
        ...
        pm.adjugate_transpose(self.basis, self.basis_forces, self.num_dim)
